...
Run these test cases once the Claude Project is set up. Each one is designed to expose a specific kind of weakness in the tool. If it handles all five well, you're ready to move to v2 (the web app).
